...
class RelationDataset(Dataset):
    ...
    def __init__(self, json_file, relations=ALL_RELATIONS, transform=None):
        ...
        self.relations = list(all_relations.values())
...
class TaxonomyRelationDataset(Dataset):
    """Taxonomy relations dataset."""
    ...
    def __init__(self, json_file, relations=ALL_RELATIONS, transform=None):
        ...
        """
        all_relations = json.load(json_file)
        unused_relations = [relation for relation in relations_dict.keys() if relation not in TAXONOMY RELATIONS]
        for unused_relation in unused_relations:
            all_relations.pop(unused_relation)
        self.relations = list(all_relations.values())
        self.transform = transform
...
class MeronymRelationDataset(Dataset):
    """Meronymic relations dataset."""
    ...
    def __init__(self, json_file, relations=ALL_RELATIONS, transform=None):
        ...
        """
        all_relations = json.load(json_file)
        unused_relations = [relation for relation in relations_dict.keys() if relation not in STRUCTURE_RELATIONS]
        for unused_relation in unused_relations:
            all_relations.pop(unused_relation)
        self.relations = list(all_relations.values())
        self.transform = transform
